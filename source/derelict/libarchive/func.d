...
class DerelictLibArchiveLoader : SharedLibLoader {
	...
	protected override void loadSymbols() {
		...
		bindFunc(cast(void**)&archive_libzstd_version,"archive_libzstd_version");
		bindFunc(cast(void**)&archive_liblzo2_version,"archive_liblzo2_version");
		bindFunc(cast(void**)&archive_libexpat_version,"archive_libexpat_version");
		bindFunc(cast(void**)&archive_libbsdxml_version,"archive_libbsdxml_version");
		bindFunc(cast(void**)&archive_libxml2_version,"archive_libxml2_version");
		bindFunc(cast(void**)&archive_mbedtls_version,"archive_mbedtls_version");
		bindFunc(cast(void**)&archive_nettle_version,"archive_nettle_version");
		bindFunc(cast(void**)&archive_openssl_version,"archive_openssl_version");
		bindFunc(cast(void**)&archive_libmd_version,"archive_libmd_version");
		bindFunc(cast(void**)&archive_commoncrypto_version,"archive_commoncrypto_version");
		bindFunc(cast(void**)&archive_cng_version,"archive_cng_version");
		bindFunc(cast(void**)&archive_wincrypt_version,"archive_wincrypt_version");
		bindFunc(cast(void**)&archive_librichacl_version,"archive_librichacl_version");
		bindFunc(cast(void**)&archive_libacl_version,"archive_libacl_version");
		bindFunc(cast(void**)&archive_libattr_version,"archive_libattr_version");
		bindFunc(cast(void**)&archive_libiconv_version,"archive_libiconv_version");
		bindFunc(cast(void**)&archive_libpcre_version,"archive_libpcre_version");
		bindFunc(cast(void**)&archive_libpcre2_version,"archive_libpcre2_version");
		bindFunc(cast(void**)&archive_read_support_filter_by_code,"archive_read_support_filter_by_code");
		bindFunc(cast(void**)&archive_read_support_format_rar5,"archive_read_support_format_rar5");
		bindFunc(cast(void**)&archive_write_add_filter_zstd,"archive_write_add_filter_zstd");
		bindFunc(cast(void**)&archive_write_set_format_cpio_bin,"archive_write_set_format_cpio_bin");
		bindFunc(cast(void**)&archive_write_set_format_cpio_odc,"archive_write_set_format_cpio_odc");
		bindFunc(cast(void**)&archive_write_set_format_cpio_pwb,"archive_write_set_format_cpio_pwb");
		bindFunc(cast(void**)&archive_write_zip_set_compression_lzma,"archive_write_zip_set_compression_lzma");
		bindFunc(cast(void**)&archive_write_zip_set_compression_xz,"archive_write_zip_set_compression_xz");
		bindFunc(cast(void**)&archive_write_zip_set_compression_bzip2,"archive_write_zip_set_compression_bzip2");
		bindFunc(cast(void**)&archive_write_zip_set_compression_zstd,"archive_write_zip_set_compression_zstd");
		bindFunc(cast(void**)&archive_write_open2,"archive_write_open2");
		bindFunc(cast(void**)&archive_parse_date,"archive_parse_date");
		bindFunc(cast(void**)&archive_match_set_inclusion_recursion,"archive_match_set_inclusion_recursion");
		bindFunc(cast(void**)&archive_entry_filetype_is_set,"archive_entry_filetype_is_set");
		bindFunc(cast(void**)&archive_entry_set_link_to_hardlink,"archive_entry_set_link_to_hardlink");
		bindFunc(cast(void**)&archive_entry_set_link_to_symlink,"archive_entry_set_link_to_symlink");
		bindFunc(cast(void**)&archive_entry_symlink_type,"archive_entry_symlink_type");
		bindFunc(cast(void**)&archive_entry_uid_is_set,"archive_entry_uid_is_set");
		bindFunc(cast(void**)&archive_entry_copy_fflags_text_len,"archive_entry_copy_fflags_text_len");
